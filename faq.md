...
Yes. The full source code is available at [github.com/sieve-labs/sieve-app](https://github.com/sieve-labs/sieve-app) under the MIT license.

**Can I use Sieve commercially?**\
Yes. The MIT license allows use for any purpose including commercial use.

**How do I report a bug or request a feature?**\
Open an issue on the [GitHub repository](https://github.com/sieve-labs/sieve-app/issues).
