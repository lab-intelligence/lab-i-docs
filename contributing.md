...
**Report a bug**\
Open an issue on the [GitHub repository](https://github.com/sieve-labs/sieve-app/issues). Include your platform (Android, Linux, Windows, macOS), what you expected to happen, and what actually happened. Screenshots help.

**Request a feature**\
Open an issue and describe what you need and why. The most useful feature requests come from actual workflows — if something would genuinely save you time, it is worth raising.

**Improve the documentation**\
The docs live in the [sieve-docs repository](https://github.com/sieve-labs/sieve-docs). If something is unclear, missing, or wrong, open a pull request with your changes. Documentation contributions are just markdown — no coding required.

**Contribute code**\
The app is built in Flutter. If you want to fix a bug or add a feature:

1. Fork the [sieve-app repository](https://github.com/sieve-labs/sieve-app)
